...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * | Gui | App | Alt | CTL |  L2  |   Space   |  L1  | Left| Down|  Up |Right|
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  KC_LGUI, KC_APP, KC_LALT, KC_LCTL,  MO(2),      KC_SPC,        MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
LAYOUT( /* Tab */
  ...
  RESET,   LED_TOG, LED_CHG, _______, _______, _______, _______, _______, _______, _______, _______, _______,
